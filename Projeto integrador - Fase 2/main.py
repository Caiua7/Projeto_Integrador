...
# Requisitos para o funcionamento do sistema: Abrir o terminal e digitar o seguinte comando: "pip install pandas" e "pip install oracledb" (Instalação da biblioteca referente a tabela e banco de dados) 
